...
const SS_SUB_ISSUE_BUNDLES: SsSubIssueBundle[] = [
  {
    ...
    contextWriteUp: "Housing inequality in Singapore is the question of whether the gap between owners of million-dollar resale flats, long-wait BTO applicants and public-rental tenants is hardening into a class divide that cuts across citizenship itself. HDB frames public housing as the cornerstone of nation-building — over 80% of residents live in HDB flats and around 90% own their homes — and argues subsidies, the Ethnic Integration Policy and shared amenities still give every citizen a common stake in the country. Younger first-time buyers and commentators describe a different reality, with mature-estate resale priced out of reach and a two-tier market that rewards those who got in early. Researchers at IPS go further, finding that class divisions in everyday social networks are now sharper than racial ones, while the OECD warns that when housing becomes the main driver of wealth inequality, citizens come to see life chances as set by inheritance rather than shared rules. The Government has responded with the Plus and Prime BTO classification and tighter resale conditions, framed as a corrective to keep public housing accessible. The issue matters because housing is the single largest asset most Singaporeans will ever own and the most visible test of whether the citizenship promise of equal opportunity still holds.",
