...
const CURATED_HUMANITIES_BUNDLES: CuratedBundle[] = [
  // --- WWII outbreak / appeasement ---
  {
    ...
    contextWriteUp: "This SBQ examines the international crisis of the 1930s that ended in the outbreak of the Second World War. After 1933, Hitler steadily challenged the post-Versailles settlement — remilitarising the Rhineland, annexing Austria, demanding the Sudetenland — while Britain and France hoped that giving in to limited demands would secure a lasting peace. The League of Nations, weakened by the Abyssinian crisis, failed to act collectively. By 1939, after the Nazi-Soviet Pact and the invasion of Poland, war had returned to Europe. The sources below let you weigh how far appeasement, rather than Hitler's ambitions or wider failures of collective security, was the decisive cause.",
    sources: [
  ...
  // --- Rise of Nazism / Weimar Germany / authoritarian rule in Germany ---
  {
    ...
    contextWriteUp: "This SBQ investigates how Hitler and the Nazi Party rose from a fringe movement in the 1920s to total control of Germany by 1934. The Weimar Republic faced repeated shocks — defeat in 1918, the Treaty of Versailles, hyperinflation, mass unemployment after 1929 — that drained public faith in democratic parties. Hitler combined legal political manoeuvring with intimidation by the SA, exploiting events like the Reichstag fire to push through the Enabling Act, and after Hindenburg's death merged the offices of Chancellor and President. The sources let you weigh how far Nazi success was due to Weimar's weaknesses, the Nazi Party's own organisation and propaganda, or violence against opponents.",
    sources: [
  ...
  // --- Militarist Japan / authoritarian rule in Japan, 1920s–1930s ---
  {
    ...
    contextWriteUp: "This SBQ examines how Japan, a constitutional state with a civilian parliament in the 1920s, became dominated by the military by the late 1930s. Economic crisis, frustration with party politicians and ultranationalist ideology pushed army officers — especially in Manchuria — to act on their own initiative. The Mukden Incident of 1931, the May 15 and February 26 incidents, and Japan's walk-out from the League of Nations each marked stages in this shift. School textbooks like Kokutai no Hongi taught absolute loyalty to the emperor. The sources let you weigh how far militarist rule was driven by the army defying civilian government, by popular support, or by state-led ideology.",
    sources: [
  ...
  // --- Stalinist USSR / authoritarian rule in the Soviet Union ---
  {
    ...
    contextWriteUp: "This SBQ examines how Stalin consolidated authoritarian rule in the USSR after Lenin's death. From the late 1920s he launched the Five-Year Plans to industrialise the country, forced peasants into collective farms, and used the NKVD to imprison, deport or shoot millions during the Great Terror and in the Gulag. Public 'show trials' of Old Bolsheviks gave a judicial face to a much wider campaign of terror, while propaganda built a cult of personality presenting Stalin as Lenin's natural heir. The sources let you weigh how far Stalin's grip on power rested on terror, on the economic gains of industrialisation, or on the cult of personality.",
    sources: [
  ...
  // --- Cold War origins ---
  {
    ...
    contextWriteUp: "This SBQ examines how the wartime alliance between the United States and the Soviet Union collapsed into open hostility between 1945 and 1949. Disagreements over the future of Germany and Eastern Europe, the spread of communism in Greece and Turkey, and competing visions of post-war reconstruction quickly hardened into rival blocs. Kennan's Long Telegram framed Soviet behaviour as inherently expansionist; the Truman Doctrine, the Marshall Plan, the Berlin Blockade and the formation of NATO each marked a step in this division. The sources let you weigh how far the Cold War was caused by US containment, by Soviet expansion in Europe, or by mutual ideological misunderstanding.",
    sources: [
  ...
  // --- End of the Cold War / collapse of the USSR ---
  {
    ...
    contextWriteUp: "This SBQ examines how the Cold War ended between 1985 and 1991. Mikhail Gorbachev's reforms — perestroika, glasnost and a turn away from arms-race spending — were intended to save Soviet socialism, not to end the bloc. But they loosened controls in Eastern Europe, enabled the fall of the Berlin Wall in 1989, and culminated in the dissolution of the USSR in December 1991. At the same time, sustained US military and economic pressure under Reagan, the INF Treaty, and the visible appeal of Western life played their part. The sources let you weigh how far Gorbachev's leadership, Western policy, or internal Soviet weaknesses were decisive.",
    sources: [
  ...
  // --- Decolonisation in Southeast Asia / Singapore independence ---
  {
    ...
    contextWriteUp: "This SBQ examines Singapore's path from joining Malaysia in 1963 to separating from it in August 1965. Merger was promoted as the natural decolonisation outcome — ending British rule, giving Singapore a wider economic hinterland, and combining a multi-racial Federation. But sharp disagreements quickly emerged: over racial politics and Lee Kuan Yew's call for a 'Malaysian Malaysia', over taxation and the common market, and over how to respond to Indonesian Konfrontasi. By August 1965, leaders in Kuala Lumpur and Singapore concluded that separation was unavoidable. The sources let you weigh how far separation was driven by irreconcilable political and racial differences rather than economic disagreements.",
    sources: [
...
const SS_SUB_ISSUE_BUNDLES: SsSubIssueBundle[] = [
  {
    ...
    contextWriteUp: "Housing inequality in Singapore raises the question of whether a country built on the idea of public housing as the common stake of every citizen is quietly hardening into a class society. The tension sits between two facts that are both true: more than 80 percent of residents live in HDB flats and around 90 percent own their homes, yet the gap between owners of million-dollar resale flats, applicants stuck on long BTO waits and households in public rental is now visible enough to feel like a divide. Officially, public housing is still framed as the cornerstone of nation-building, with subsidies, ethnic-quota rules and tighter resale conditions positioned as deliberate correctives that keep flats accessible across the income range. Younger first-time buyers and many commentators tell a different story, arguing that timing and family wealth — who got in early, who inherits a flat — increasingly decide outcomes more than effort or shared rules. Researchers warn that class divisions in everyday social networks are now sharper than racial ones, and comparative evidence from other high-income societies shows what happens when housing becomes the main driver of wealth inequality: citizens stop believing life chances are equally distributed. The issue matters because housing is the largest asset most Singaporeans will ever own and the most visible test of whether the citizenship promise of equal opportunity still holds in practice.",
  ...
  },
  {
    ...
    contextWriteUp: "HDB public housing sits at the centre of an unresolved question about whether decades of building flats has actually produced a shared Singaporean identity, or only provided shelter on a national scale. The tension is sharpest where policy meets daily life: the same estates that the official narrative treats as the everyday infrastructure of nation-building — void decks, mixed-race blocks, neighbourhood schools and hawker centres — are also where younger Singaporeans now feel the strain of record resale prices, long BTO waits and tighter resale rules. The official position is that ethnic-quota rules, shared amenities and near-universal home ownership keep public housing the common ground on which Singaporean identity is formed. Many sociologists support that view, arguing that the 'heartland' figure in political speech and popular culture is unimaginable without growing up in an HDB block. Others counter that housing now sorts people by timing and family wealth rather than by a shared starting line, and that class divisions in social networks are increasingly more rigid than racial ones; comparative evidence warns that high-coverage public-housing systems can drift from citizenship asset to wealth marker once prices outpace incomes. The issue matters because if public housing stops binding citizens to a common experience, the single policy with the widest daily reach into Singaporean lives loses its identity-shaping work.",
    ...
    sources: [
      { excerpt: `The Housing & Development Board describes public housing as "the cornerstone of nation building". Since 1960, HDB has built more than one million flats; over 80% of Singapore's resident population now lives in HDB flats, and about 90% own their homes. HDB frames the programme as creating "a stake in the country" for every citizen — through subsidised prices, the Ethnic Integration Policy, void decks and shared neighbourhood amenities — so that being a Singaporean and living in an HDB estate are, in everyday life, closely intertwined.`, source_url: "https://www.hdb.gov.sg/about-us/our-role/public-housing-a-singapore-icon", source_title: "Public Housing — A Singapore Icon", publisher: "Housing & Development Board, Singapore", perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `Singapore's Ethnic Integration Policy (EIP), introduced in 1989, sets ethnic quotas in every HDB block and neighbourhood that mirror the national Chinese, Malay and Indian/Other shares. The Ministry of National Development argues that without the EIP, ethnic enclaves would re-form and weaken daily inter-racial contact in lifts, void decks, schools and hawker centres. The policy is presented as evidence that HDB is not just a housing programme but a deliberate instrument for producing a shared Singaporean identity rather than a federation of ethnic communities.`, source_url: "https://www.hdb.gov.sg/residential/buying-a-flat/resale/ethnic-integration-policy-and-spr-quota", source_title: "Ethnic Integration Policy in HDB estates", publisher: "Housing & Development Board, Singapore", perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `In a 2020 Channel NewsAsia commentary, sociologist Chua Beng Huat argued that the HDB estate — with its void decks, wet markets, neighbourhood schools and coffee shops — has become "the everyday infrastructure of Singaporean identity". He noted that the 'heartland' figure in political speech, the imagery of National Day Parade neighbourhood celebrations, and even local films set in HDB estates all draw on a shared experience of growing up in public housing. Without that common backdrop, he warned, "Singaporean" would shrink back to an ethnic or class category.`, source_url: "https://www.channelnewsasia.com/commentary/hdb-public-housing-singaporean-identity-heartland-void-deck-2080686", source_title: "HDB estates and the everyday infrastructure of Singaporean identity, 2020", publisher: "Channel NewsAsia", perspective: ["individual", "expert"], stance: "supportive" },
      { excerpt: `In 2023, more than 470 HDB resale flats crossed the S$1 million mark, more than double the 2022 figure. Younger first-time buyers reported being priced out of mature-estate resale and waiting years for Build-To-Order launches in newer towns. Commentators warned that when an HDB flat shifts from a shared "stake in the country" into a marker of who got in early, the policy's identity-binding role weakens. The 2023 introduction of the Plus and Prime classification — with longer minimum occupation and tighter resale rules — was framed by the Government as a corrective to keep public housing "accessible and affordable for all Singaporeans".`, source_url: "https://www.channelnewsasia.com/singapore/hdb-resale-million-dollar-flats-2023-record-4040631", source_title: "Record number of million-dollar HDB resale flats in 2023", publisher: "Channel NewsAsia", perspective: ["individual"], stance: "opposing" },
      { excerpt: `An Institute of Policy Studies working paper on housing and social capital in Singapore (2019) found that respondents from public-rental and smaller HDB flats were significantly less likely to have close friends from condominium or landed-property backgrounds, and vice versa. The authors argued that "class divisions are now more rigid than racial divisions" in everyday social networks, and that if housing type increasingly tracks class, the daily mixing HDB was designed to produce will weaken — eroding the shared identity that public housing was meant to anchor.`, source_url: "https://lkyspp.nus.edu.sg/ips/publications/details/a-study-on-social-capital-in-singapore", source_title: "IPS study on housing, class and social capital in Singapore, 2019", publisher: "Lee Kuan Yew School of Public Policy, NUS", perspective: ["expert"], stance: "opposing" },
      { excerpt: `The OECD's 2020 report "Social Housing: A Key Part of Past and Future Housing Policy" reviewed public-housing systems across member economies and highlighted Singapore's HDB as an unusually high-coverage model, noting that "few countries have used public housing as deliberately as Singapore to shape national identity and inter-ethnic mixing". The report cautioned, however, that as resale-market prices rise faster than incomes — a pattern seen in several OECD members — public housing can drift from a shared citizenship asset into a marker of timing and family wealth, weakening the very inclusion it was built to support.`, source_url: "https://www.oecd.org/social/social-housing-policy-brief-2020.pdf", source_title: "OECD Social Housing Policy Brief, 2020", publisher: "OECD", perspective: ["foreign", "expert"], stance: "mixed" },
    ],
  },
  {
    issue: 1,
    subIssue: "National Service and Singaporean citizenship",
    assertion: "National Service has done more than any other policy to bind Singaporean men to their citizenship.",
    contextWriteUp: "National Service is the two-year compulsory military, police or civil-defence stint that every male Singapore citizen and second-generation male PR has owed the state since 1967, followed by up to a decade of reservist cycles — and the question is what kind of citizenship that long obligation actually produces. The tension is that NS is framed as the most concrete answer to what it means to be Singaporean, yet it falls on only one half of the citizenry and excludes entire groups inside the country. The official position treats NS as both a defence necessity for a small state and a deliberate citizenship-forging rite that mixes young men across race, language and class, with the shared hardship doing identity work no classroom can replicate. Many NSmen agree, describing a 'thick, lived' sense of being Singaporean that they trace directly to enlistment. Others point out that women, new citizens who arrive after the eligible age and first-generation PRs are entirely outside this experience, so NS may deepen citizenship for some while widening the gap with everyone else. Comparative debate in other conscript societies shows younger, more mobile citizens increasingly contesting whether the model can hold, raising the same questions of fairness and relevance heard at home. The issue matters because NS still consumes years of every male citizen's life and remains the clearest policy answer Singapore has given to what the obligations of citizenship actually are.",
    inquiryQuestion: "How far has National Service shaped what it means to be a Singaporean citizen?",
    triggers: /(national service|\bns\b|\bnsf\b|nsmen|nsman|conscription|enlist|enlistment|mindef|\bsaf\b|reservist|ict\b|operationally ready|citizen soldier|pr.{0,15}(ns|service)|exempt.{0,15}(ns|service))/i,
    sources: [
      { excerpt: `The National Service (Amendment) Act, passed by Parliament on 14 March 1967, made full-time military service compulsory for all able-bodied male Singapore citizens. Introducing the Bill, then-Defence Minister Goh Keng Swee argued that a newly independent Singapore could not rely on others for its security and that a citizen army was "the only way a small state can defend itself". Beyond defence, Goh framed NS as a deliberate nation-building instrument: it would, he said, mix young men "from all races, all classes, all schools" in a shared rite that would make them feel, for the first time, that they were Singaporean before they were Chinese, Malay or Indian.`, source_url: "https://www.mindef.gov.sg/web/portal/mindef/about-us/history/birth-of-saf/v/national-service-act-1967", source_title: "Goh Keng Swee on the National Service (Amendment) Act, 1967", publisher: "Ministry of Defence, Singapore", perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `The Ministry of Defence describes National Service as "a rite of passage for every Singaporean son" and "the strongest expression of our shared citizenship". MINDEF materials note that since 1967, more than one million Singaporeans have completed full-time NS, that NSFs serve alongside peers from every racial and socioeconomic background, and that the reservist cycle keeps men connected to a national institution well into their forties. Officials argue this is what gives the SAF its legitimacy as a citizen army, and why NS is treated as inseparable from the meaning of Singaporean citizenship rather than as a tax paid by some on behalf of others.`, source_url: "https://www.mindef.gov.sg/web/portal/mindef/defence-matters/defence-topic/defence-topic-detail/national-service", source_title: "About National Service in Singapore", publisher: "Ministry of Defence, Singapore", perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `Speaking at the NS50 commemoration in 2017, then-Prime Minister Lee Hsien Loong said: "National Service is the crucible in which our young men first experience what it means to be Singaporean. They do not just learn to defend Singapore — they learn to live with one another, to depend on one another, regardless of race or background. That shared experience is what makes citizenship more than a passport." The speech reaffirmed NS as both a defence policy and a citizenship policy, and explicitly tied any future revisions of NS terms to the question of whether they would strengthen or weaken the bond between Singaporean men and their country.`, source_url: "https://www.pmo.gov.sg/Newsroom/PM-Lee-Hsien-Loong-at-NS50-Commemoration-Dinner", source_title: "PM Lee Hsien Loong at the NS50 Commemoration, 2017", publisher: "Prime Minister's Office, Singapore", perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `In Parliament on 9 January 2017, the Minister for Defence stated that first-generation permanent residents who become PRs as adults are not liable for NS, but that "second-generation male PRs", being sons of PRs who renew their PR status as they come of age, must serve NS like Singapore citizens, or risk losing their PR status and being barred from re-entry. The Minister said this rule existed precisely because NS is regarded as "an obligation that comes with the long-term benefits of living in Singapore", and that allowing PR sons to opt out would be seen by Singaporeans as unfair to those who serve.`, source_url: "https://www.mindef.gov.sg/web/portal/mindef/news-and-events/latest-releases/article-detail/2017/january/2017jan09-news-releases-00040", source_title: "MINDEF Parliamentary reply on PR sons and NS liability, January 2017", publisher: "Ministry of Defence, Singapore", provenance: `MINDEF reply tabled in Parliament on 9 January 2017 in response to a question on whether PRs should be liable for NS in the same way as Singapore citizens.`, perspective: ["gov_official"], stance: "supportive" },
      { excerpt: `An Institute of Policy Studies commentary in Channel NewsAsia argued that National Service has produced a strong but uneven sense of Singaporean citizenship. Drawing on focus-group data, the author noted that NS gives Singaporean men "a thick, lived experience" of citizenship — shared hardship, friendships across race and class, a sense of having paid something to the country — that women, new citizens who arrive after the eligible age, and first-generation PRs largely cannot access. The commentary warned that as the share of residents who never serve grows, NS may bind Singaporean men more tightly to citizenship even as it widens the gap between them and other residents.`, source_url: "https://lkyspp.nus.edu.sg/ips/research/details/national-service-and-citizenship", source_title: "IPS commentary: National Service, identity and the uneven reach of citizenship", publisher: "Institute of Policy Studies / Channel NewsAsia", perspective: ["individual", "expert"], stance: "opposing" },
      { excerpt: `A 2019 BBC News feature on conscription in East Asia compared Singapore's two-year National Service with South Korea's roughly 18-month military service and Taiwan's shortened four-month training. The report noted Singapore officials' insistence that NS is "as much about citizenship as defence", but also quoted regional analysts who observed that compulsory service in all three societies is increasingly contested by younger citizens who travel, study and work abroad, and who question whether a long full-time stint plus a decade of reservist call-ups can be sustained as ideas of citizenship become more transnational.`, source_url: "https://www.bbc.com/news/world-asia-49319223", source_title: "Conscription and citizenship in East Asia", publisher: "BBC News", perspective: ["foreign"], stance: "opposing" },
    ],
  },
  {
    issue: 1,
    ...
    contextWriteUp: "Civic participation in Singapore raises the question of whether citizens have a real voice in shaping public policy or only a structured opportunity to be heard. The tension runs between an active conception of citizenship — embodied in the Pledge and in wide consultation exercises involving hundreds of thousands of participants — and a legal frame that keeps the final word firmly with the state. The official position is that channels for input are deliberately broad, and that mass consultations prove citizens help set direction rather than just react to it. The legal frame, however, is tighter: constitutional and public-order provisions allow Parliament to restrict speech, assembly and protest in the interests of stability, and public political gatherings remain confined to Speakers' Corner. Civil-society voices describe the result as 'wide but shallow' — citizens are consulted often, but the line between feedback and binding decision stays with the executive — while international cases from large-scale street protests to comparative trust-in-government research show what happens when people feel consulted but not heard. The issue matters because the legitimacy of any modern state, including Singapore's, increasingly turns on whether citizens believe their input genuinely changes outcomes rather than merely registering them.",
  ...
  },
  {
    ...
    contextWriteUp: "Managing race and religion in Singapore raises the question of whether harmony between communities is produced mainly by deliberate state policy or by everyday social mixing — and what happens when the two are pulled apart. The tension is that a society that prides itself on lived multiracial life also relies heavily on legal instruments to prevent that life from breaking down. The official position is that policy is doing the heavy lifting: ethnic quotas in every HDB block keep communities in daily contact, and laws on religious harmony allow the state to pre-empt leaders who mix faith with politics or stoke inter-group hostility. Individual experience suggests harmony is also negotiated case by case, as recent shifts on workplace religious dress show — welcomed by some as overdue, questioned by others as overly mediated by the state. Comparative cases elsewhere — bans on religious symbols for teachers, police and judges in parts of Europe and Canada that drew challenges from Muslim, Sikh and Jewish groups — show how contested the same ground becomes when policy and contact pull apart. Survey evidence in Singapore lands in between, with strong agreement that policy underwrites harmony and majority reporting of close cross-racial friendships, suggesting policy and contact reinforce rather than substitute for each other. The issue matters because a small, religiously plural society has no margin for the kind of inter-group breakdown seen elsewhere, and the model of harmony chosen now shapes what is normal for the next generation.",
  ...
  },
  {
    ...
    contextWriteUp: "About 1.49 million foreign workers live in Singapore, and the question is whether they belong to the diverse society they have physically built or remain functionally excluded from it. The Government acknowledges migrant workers as 'essential partners' in development, with roughly 442,000 Work Permit holders concentrated in construction, marine and process sectors — but typically tied to a single employer and housed in dedicated dormitories away from citizen residential life. The 2020 COVID-19 outbreaks, which at one point accounted for over 90% of Singapore's confirmed cases, made dormitory conditions visible and triggered a programme to build new lower-occupancy housing, though commentators asked why the situation had been allowed to develop. NGOs like TWC2 describe ground-level cases of unpaid wages, injury claims and abrupt repatriation, arguing that visa terms tying workers to one employer make formal complaints economically punishing. The ILO's global migrant-worker report supports this critique, warning that economic inclusion without legal and social inclusion is unsustainable; an IPS-CNA survey found 71% of citizens believed migrant workers were treated unfairly during COVID-19, but only 44% supported integrating dormitories into HDB estates. The issue matters because Singapore's diverse-society narrative is tested most sharply at exactly the point where economic interdependence meets residential and social distance.",
  ...
  },
  {
    ...
    contextWriteUp: "Foreign immigrants — new citizens and permanent residents drawn from across Asia and beyond — sit at the centre of an unresolved debate about whether newcomers can genuinely integrate into Singapore's way of life. The 2013 Population White Paper warned that without continued immigration the citizen population would begin shrinking from around 2025 and proposed taking in tens of thousands of new citizens and PRs each year, prompting a Hong Lim Park protest of several thousand — the largest in years. The Government runs the National Integration Council and the Singapore Citizenship Journey to introduce newcomers to local history and norms, while framing integration as a 'two-way process' that also asks Singaporeans to be open. Locals, by contrast, often judge integration by language, accent, food habits and willingness to bear NS, with IPS-OnePeople.sg finding 51% of citizens think newcomers are not making enough effort; new citizens and PRs measure it by workplace acceptance and freedom to keep home-country ties, with only 33% reporting close Singaporean friends outside their own group. Sociologist Terence Chong argues this 'everyday friction' is normal and that genuine belonging is a generational process settled by the children of new citizens, while OECD comparative work notes integration outcomes are strongest where settlement programmes are matched by routine personal contact. The issue matters because Singapore's demographic and economic future depends on continued immigration, but its social cohesion depends on whether newcomers actually become Singaporean rather than parallel residents.",
  ...
  },
  {
    ...
    contextWriteUp: "Singapore's open economy — with external trade running at roughly 3.5 times GDP and 27 free-trade agreements in force — has lifted national prosperity, but the question is whether ordinary Singaporean workers share in those gains or absorb most of the costs. The Government's position, set out by the Minister for Trade and Industry, is that staying 'deeply plugged into the global economy' raises consumer choice and creates jobs, with SkillsFuture and Workfare designed as the cushions that make exposure to global competition manageable. SkillsFuture reports more than 660,000 users and 270,000 mid-career re-skillers, though labour economists note uptake skews towards higher-educated workers and the bottom income quintile has seen the slowest real-wage growth. Individual experience captures the gap directly, as in CNA's interview with a 53-year-old precision-engineering technician retrenched after his Tuas plant was offshored, who told the reporter that 'every FTA means I have to start over'. International cases like the UK's 2016 Brexit vote, where 51.9% backed leaving the EU partly on the argument that integration's gains had not reached ordinary voters, show what can happen politically when distribution lags too far behind growth; Singapore's Gini after transfers fell to 0.371 in 2022 — the lowest in two decades — but the drop relied on redistribution, not on pre-tax wages. The issue matters because the open-economy bet shapes every Singaporean's working life, and whether the model holds depends on whether workers continue to believe it works for them.",
    ...
    sources: [
      { excerpt: `In a 2023 speech, Singapore's Minister for Trade and Industry argued that the country's economic strategy depends on staying "deeply plugged into the global economy". He noted that Singapore's external trade was about 3.5 times its GDP and that the country has signed 27 free-trade agreements with major economies. Free trade, the minister said, raises consumer choice, attracts foreign investment and creates jobs — but also exposes workers to global competition, which is why active retraining and SkillsFuture programmes are integral to the open-economy strategy.`, source_url: "https://www.mti.gov.sg/Newsroom/Speeches", source_title: "Singapore's open-economy strategy, 2023", publisher: "Ministry of Trade and Industry, Singapore", perspective: ["gov_official"], stance: "opposing" },
      { excerpt: `The World Trade Organization's 2023 World Trade Report observed that "the share of world output traded internationally rose from 20% in 1995 to a peak of 31% in 2008, and has hovered around 30% since". Integration has lifted hundreds of millions out of extreme poverty, but has also concentrated production in specific regions, exposing supply chains to disruption — as the COVID-19 pandemic and the Russia–Ukraine war demonstrated. The WTO argues for "re-globalisation" — broader, more inclusive integration, not retreat.`, source_url: "https://www.wto.org/english/res_e/booksp_e/wtr23_e/wtr23_e.pdf", source_title: "WTO World Trade Report 2023", publisher: "World Trade Organization", perspective: ["foreign", "expert"], stance: "mixed" },
      { excerpt: `SkillsFuture Singapore reported that as of end-2022, more than 660,000 Singaporeans had used SkillsFuture Credit and over 270,000 mid-career workers had completed Workforce Skills Qualifications courses. SSG case studies highlighted retrenched manufacturing workers retrained for cybersecurity and logistics roles. Officials presented these numbers as evidence that the open-economy model can be made to work for workers; labour economists noted uptake remained skewed towards higher-educated workers, and that the lowest-paid quintile of citizens had seen the slowest real-wage growth.`, source_url: "https://www.ssg.gov.sg/about/skillsfuture-impact.html", source_title: "SkillsFuture Singapore impact figures, 2022", publisher: "SkillsFuture Singapore", perspective: ["gov_official"], stance: "mixed" },
      { excerpt: `On 23 June 2016, the United Kingdom voted by 51.9% to 48.1% to leave the European Union. The Leave campaign argued EU membership had eroded national control over borders, regulation and trade policy; the Remain campaign argued economic interdependence with EU partners — half of UK trade — was the foundation of British prosperity. UK studies suggest Brexit reduced UK trade in goods by around 7% by 2023. The case shows how voters in advanced economies can push back against deep integration when they feel its gains have not reached them.`, source_url: "https://www.bbc.com/news/uk-politics-32810887", source_title: "UK votes to leave the European Union, June 2016", publisher: "BBC News", perspective: ["foreign"], stance: "supportive" },
      { excerpt: `Singapore's Department of Statistics reported that the Gini coefficient for resident employed households (after government transfers and taxes) fell from 0.401 in 2017 to 0.371 in 2022, the lowest in two decades. The Department attributed the move to progressive transfers — Workfare, GST Vouchers, Silver Support — rather than to pre-tax wages. Commentators argued this confirms the open-economy model produces unequal market outcomes which only sustained redistribution can offset, raising the question of whether the underlying model genuinely serves ordinary workers or merely compensates them.`, source_url: "https://www.singstat.gov.sg/find-data/search-by-theme/households/household-income/latest-data", source_title: "Key Household Income Trends, Singapore, 2022", publisher: "Department of Statistics, Singapore", perspective: ["gov_official", "expert"], stance: "supportive" },
      { excerpt: `In a 2022 Channel NewsAsia "On The Record" feature, retrenched precision-engineering technician Mr Tan, 53, described how the closure of his employer's Tuas plant after work was offshored left him jobless for nearly a year before he completed an SSG-funded logistics course and found a warehouse role at lower pay. "The country is doing well," he told the reporter, "but for people like me, every FTA means I have to start over." Labour MPs cited his case in Parliament as a reminder that headline trade figures hide unequal exposure to global competition, particularly for older, lower-credentialled Singaporean workers.`, source_url: "https://www.channelnewsasia.com/singapore/older-worker-retrenched-globalisation-skillsfuture-2880236", source_title: "On The Record: an older worker on the cost of an open economy, 2022", publisher: "Channel NewsAsia", perspective: ["individual"], stance: "supportive" },
    ],
  },
  {
    issue: 3,
    ...
    contextWriteUp: "Globalisation and Singaporean cultural identity is the question of whether a small, hyper-connected city-state can sustain a distinctive culture when streaming platforms, K-pop and Hollywood dominate daily media diets. The Government has pushed in both directions: campaigns like Speak Good English Movement (2000) treat home-grown forms such as Singlish as a competitiveness risk, while the Ministry of Culture, Community and Youth invests in heritage festivals, the SG Culture Pass and local-arts programming as 'deliberate counterweights to globalised media'. Industry data shows the scale of the inbound force — over 60% of Netflix subscribers globally watched a Korean-language title in 2023, and K-drama tops Singaporean 15-24-year-olds' viewing — while sociologist Daniel Goh argues that Singaporean culture has always been 'consciously hybrid', reworking East Asian, South Asian, Malay-Indonesian and Anglo-American influences into hawker-centre, void-deck and code-switched forms. UNESCO's 2022 report frames the wider stakes, warning that smaller markets risk becoming consumers rather than producers of culture without active local-content policy, and naming Singapore alongside Norway and South Korea as states making deliberate budgetary bets to stay producers. Critics on both sides ask whether subsidised attendance and content quotas actually translate into lasting cultural identification, and whether globalisation enriches the local hybrid or quietly displaces it. The issue matters because the cultural texture of being Singaporean — what people watch, eat, sing and joke in — is increasingly settled outside the country's borders.",
