...
const SS_SUB_ISSUE_BUNDLES: SsSubIssueBundle[] = [
  ...
  },
  {
    ...
    contextWriteUp: "Civic participation in Singapore is the question of whether citizens have a real voice in shaping public policy, or only a structured opportunity to be heard. The Singapore Pledge frames citizenship as an active commitment, and exercises such as Forward Singapore have run wide consultations — over 200,000 participants across sixteen months — that the Government presents as proof citizens help set direction. The legal frame, however, is tighter: Article 14 of the Constitution and the Public Order Act allow Parliament to restrict speech, assembly and protest in the interest of stability, and public political gatherings remain confined to Speakers' Corner. Civil-society voices like NUS political scientist Chong Ja Ian describe the result as 'wide but shallow' participation — citizens are consulted often but the line between feedback and binding decision stays with the Government. International cases sharpen the contrast: Hong Kong's 2019 protests showed the high-stakes street version of voice, while the OECD's 2022 Trust in Government work warns that being 'consulted but not heard' actually lowers trust below the level of having no consultation at all. The issue matters because the legitimacy of any modern state, including Singapore's, increasingly turns on whether citizens believe their input genuinely changes outcomes.",
