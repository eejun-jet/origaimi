...
const SS_SUB_ISSUE_BUNDLES: SsSubIssueBundle[] = [
  ...
  },
  {
    ...
    contextWriteUp: "This SBQ examines how far National Service (NS) has shaped what it means to be a Singaporean citizen. Under the National Service Act of 1967, all male Singapore citizens and second-generation permanent residents are required to serve two years of full-time NS in the Singapore Armed Forces, Police or Civil Defence, followed by up to a decade of reservist Operationally Ready cycles. The Government has consistently framed NS as both a defence necessity for a small state and a shared rite of citizenship that forges bonds across race, language and class. At the same time, debates over whether first-generation PRs and new citizens carry the same NS liability, the absence of women from compulsory service, and the perceived unfairness when some citizens emigrate before enlistment continue to test how far NS produces a common citizenship. Weigh the sources to judge how far NS shapes, sustains or strains Singaporean citizenship.",
